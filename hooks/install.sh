...
#   or:  bash <(curl -s https://raw.githubusercontent.com/allytag/LeanContext/main/hooks/install.sh)
...
REPO_URL="https://raw.githubusercontent.com/allytag/LeanContext/main/hooks"

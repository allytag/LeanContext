...
#        irm https://raw.githubusercontent.com/allytag/LeanContext/main/hooks/install.ps1 | iex
...
$RepoUrl = "https://raw.githubusercontent.com/allytag/LeanContext/main/hooks"
